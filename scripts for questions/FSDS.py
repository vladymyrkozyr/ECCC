...
##for twitter
#rootPath='../question answers/FSDS goals/tw/*.csv'
#rootResultPath_tagged='../question answers/FSDS goals/tw/'

#
##for facebook
#rootPath='../question answers/FSDS goals/fb/posts/*.csv'
#rootResultPath_tagged='../question answers/FSDS goals/fb/posts/'


#for instagram
rootPath='../question answers/FSDS goals/in/posts/*.csv'
rootResultPath_tagged='../question answers/FSDS goals//in/posts/'
...
keywords_filePath_EN='../17_FSDS_Goals_Keywords_EN.csv'
keywords_filePath_FR='../17_FSDS_Goals_Keywords_FR.csv'
