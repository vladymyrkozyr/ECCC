...
for file, name in zip(files, names):
    ...
    merged=merged.append(info.head(10))

merged[['id','date_published','link','caption_original','caption_cleaned','hashtags','num_comments','num_shares','num_likes','Reactions_SUM','category','matched_keywords','language','average_sentiment_score','sentiment','account_name']].to_csv(rootResultPath+'merged_TOP10_monthly.csv')
